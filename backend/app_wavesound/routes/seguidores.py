...
from app_wavesound.controllers.seguidores_services import obtener_sugerencias_de_usuarios
...
def sugerencias_usuarios(
    ...
    return obtener_sugerencias_de_usuarios(db, current_user.id_usuario)